"""
Resource Manager for TA-cvelist-v5
...
class ResourceManager:
    ...
    def __init__(
        ...
        self.logger = logger or logging.getLogger("ta_cvelist_v5.resource_manager")
...
class TimeoutManager:
    ...
    def __init__(
        ...
        self.logger = logger or logging.getLogger("ta_cvelist_v5.timeout_manager")
