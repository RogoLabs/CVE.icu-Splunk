"""
Logging Configuration for TA-cvelist-v5

Configures logging to TA-cvelist-v5.log in Splunk's log directory.
...
def setup_logging(
    ...
    Args:
        ...
        log_name: Logger name (default: ta_cvelist_v5)
...
def get_logger(name: str) -> logging.Logger:
    ...
    Args:
        name: Module name (will be prefixed with ta_cvelist_v5.)
    
    Returns:
        Logger instance
    """
    return logging.getLogger(f"ta_cvelist_v5.{name}")
