"""
CVE Processor for TA-cvelist-v5
...
class CVEProcessor:
    ...
    ERROR_SOURCETYPE = "ta:cvelist:v5:error"
    AUDIT_SOURCETYPE = "ta:cvelist:v5:audit"
    ...
    def __init__(
        ...
        self.logger = logger or logging.getLogger("ta_cvelist_v5.cve_processor")
    ...
    def create_splunk_event(
        ...
        try:
            ...
            event.host = host
            event.source = f"ta-cvelist-v5://{self.input_name}"
